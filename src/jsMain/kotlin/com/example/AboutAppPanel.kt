                ...
                div(className = "col") {
                    ...
                    div(className = "card") {
                        div(className = "card-body") {
                            // Dev environment
                            p("• Dev environment: VSCode plus Docker devcontainer (Java 21 Bullseye)", className = "card-text")
                            ...
                            // Deployment
                            p("• Deployment: Combined frontend-backend jar file to OpenShift using a Dockerfile strategy", className = "card-text")
                        }
                    }
                }
            }
                ...
                div(className = "col") {
                    ...
                    div(className = "card") {
                        div(className = "card-body") {
                            ...
                            """.trimIndent(), className = "card-text")
                        }
                    }
                }
            }
