...
object Db {
  ...
  fun init(config: ApplicationConfig) {
    ...
    transaction {
      create(IPSModelDao, MedicationDao, AllergyDao, ConditionDao, ObservationDao, ImmunizationDao)
    }
  }
  ...
  fun <T : Any> Transaction.queryList(
    ...
    val statement =
        NamedParameterPreparedStatement.createNamedParameterPreparedStatement(connection, query)
