...
// The RPC interface; add this in commonMain if you haven't yet:
interface IIPSService {
    suspend fun getAll(): List<IPSModel>
    suspend fun getById(id: Int): IPSModel?
    suspend fun create(model: IPSModel): IPSModel
    suspend fun update(id: Int, model: IPSModel): IPSModel?
